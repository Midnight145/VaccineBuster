...
public class VBPotions {
	...
	public static void init() {
		...
		antiTaint.setPotionName("COVID-19 Vaccine");
	}

	// Credit to Vazkii, author of Botania
	// Code sample found here:
	// https://github.com/Vazkii/Botania/blob/eb37715da274e31fc29dad8de98c9160a7a8f985/src/main/java/vazkii/botania/common/brew/ModPotions.java
